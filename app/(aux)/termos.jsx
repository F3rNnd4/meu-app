    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          Bem-vindo ao nosso aplicativo. Ao utilizar nossos serviços, você
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          Você se compromete a usar o aplicativo de forma ética, legal e de
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          Respeitamos sua privacidade. Os dados pessoais são tratados de acordo
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          Nosso aplicativo é fornecido "como está", sem garantias de qualquer
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          ...
          alterações serão comunicadas aos usuários.
        </Text>
      </View>
